    ...
    >
      <div className="lg:col-span-2 flex flex-col justify-evenly">
        <div className="">
          ...
          <p className="py-4">
            Come experience the very pinnacle of luxury Indonesia all-inclusive
            vacations for couples at BEACHES Resorts. Our luxury beach resorts,
            set along the most gorgeous tropical settings and exquisite beaches
            in Kelingking, Lembongan, Raja Ampat, Rinca, Tanah Lot, Wedi Klopo,
            feature unlimited gourmet dining. If you are planning a wedding,
            BEACHES is the leader in Indonesia destination weddings and
            honeymoon packages.
          </p>
        </div>
